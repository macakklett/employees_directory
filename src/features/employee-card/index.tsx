...
import CardSkeleton from '@/features/employee-card/components/employee-card-skeleton';
  ...
  return (
    <div className="employee-card__profile">
      ...
      <div className="employee-card__data birthdate">
        ...
        <span className="birthdate__date">{moment(employee.birthDate).format('D MMMM YYYY')}</span>
        <span className="birthdate__age">{moment().diff(employee.birthDate, 'years')} years</span>
      </div>
